...
export function OpeningForm({ summary }: { summary: CashSummary }) {
  ...
  return <form action={action} className="flex flex-col gap-4" noValidate ref={formRef}>
